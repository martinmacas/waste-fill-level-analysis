function [X,y,xnames] = prepare_data_papir(Time, p, labeltimes,schedule)
 [~,ind1]=ismember(labeltimes',Time);
    ...
    [c, scores, threshold, afterpicklevel] = detect_collections_thresholding(Time,p, [], []);
    ...
    ind = [ind0;ind1];
    [X,xnames] = feval('extract_features_collection_papir', p,Time,schedule,ind);
